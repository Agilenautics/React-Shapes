  ...
  return (
    <li>
      <div className="flex items-center">
        ...
        <div className="mx-1 ml-2 flex items-center justify-center bg-purple-100 p-3 text-lg font-normal text-black-400 rounded-tl-lg rounded-tr-lg shadow-md dark:text-white-400 dark:hover:text-white breadcrumb-trapezoid-purple">
          {name}
